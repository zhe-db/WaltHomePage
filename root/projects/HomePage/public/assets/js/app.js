...
$("#activate-intro").click(function(){
    ...
    if(!id){
        ...
        $("#idcard").css({"background":"url(assets/img/ID-Card-4-3.gif)","background-size":"cover"})
        id = true;
        setTimeout(function(){
            $("#about-1").css({"background":"url(assets/img/Call_Out_012-A-3.gif)","background-size":"cover"});
        },3000);
        setTimeout(function(){
            $("#learn-1").css({"background":"url(assets/img/learn-2.gif)","background-size":"cover"});
        },6000);
        setTimeout(function(){
            $("#creativity").css({"background":"url(assets/img/creativity.gif)","background-size":"cover"});
        },8500);
        setTimeout(function(){
            $("#beginner").css({"background":"url(assets/img/beginner-2.gif)","background-size":"cover"});
        },9900);
    }
    else{
...
$("#activate-intro").hover(function(){
    if(!act_hov){
        $("#activate-intro").css({"background":"url(assets/img/Special-Gadget-16-2.gif)","background-size":"cover"})
        act_hov = true;
    } else {
